...
const Contact = () => {
	...
	return (
		<>
			<SEO
				title='Contact Us | Imperia Consulting Kenya'
				description='Get in touch with Imperia Consulting for all your real estate inquiries in Kenya. Our team is here to assist you with buying, selling, and renting properties.'
				keywords='contact real estate Kenya, real estate agents Nairobi, Imperia contact, reach Imperia Consulting, property consultation Kenya'
				ogImage='https://imperiagrouponline.com/ilogo.svg'
				ogUrl='https://imperiagrouponline.com/contact'
				canonicalUrl='https://imperiagrouponline.com/contact'
			/>
						...
						>
							<div>
								...
								<p className='text-gray-600 mb-6'>
									Reach out through social media or send us a message
									below.
								</p>

...
const Contact = () => {
  ...
  return (
    ...
    >
      {/* Map Section */}
      <motion.div variants={mapVariants} className="flex justify-center">
      ...
      {/* Contact Content */}
      <motion.div variants={containerVariants} className="max-w-4xl mx-auto w-full mt-10">
          ...
          <motion.div variants={contentVariants} className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Reach out through social media or send us a message below.
              </p>
              <ul className="space-y-4">
                {socials.map((item, idx) => (
                  <li key={idx} className="flex items-center space-x-3">
                    <Icon icon={item.icon} className="text-xl text-primary-red" />
                    <a
                      href={item.link}
                      target="_blank"
